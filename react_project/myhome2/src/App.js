...
import TodoList from './component/board/board_todos';
import PhotoList from './component/board/board_photos';
      ...
      <Routes>
          ...
          */}
          <Route path="/" element={<Layout1/>}>
              ...
              <Route path="board/todo" element={<TodoList/>}/>
              <Route path="board/photo" element={<PhotoList/>}/>
          </Route>
      </Routes>
    </div>
  );
